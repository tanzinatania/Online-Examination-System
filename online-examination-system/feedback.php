...
<div class="col-md-10">
<a href="mailto:tanzinatania17@gmail.com" style="color:#000000">abcd@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/profile.png" width=100 height=100 alt="Tania" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Tanzina Nasrin Tania</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+8801700000000</h4>
		<h4 style="font-family:'typo' ">tanzinatania17@gmail.com</h4>
		<h4 style="font-family:'typo' ">City University, Dhaka</h4></div></div>
		</p>
      </div>
